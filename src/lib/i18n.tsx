...
const ar: Dict = {
  ...
  verified: "موثق",
  unverified: "غير موثق",
  request_verify: "طلب توثيق",
  verify_pending: "قيد المراجعة",
  verify_hint: "احتفظ بـ 3000 دج في رصيدك ثم اطلب التوثيق مجاناً.",
  logout: "تسجيل الخروج",
  // dashboard
...
const en: Dict = {
  ...
  verify_pending: "Pending review",
  verify_hint: "Keep 3000 DZD in your balance, then request verification for free.",
